...
public class ResearchButton {
	...
	public ResearchButton(Research research) {
		...
		f0 = new Font("Monospaced", Font.BOLD, (int) (bounds.b.clone().sub(bounds.a).y / 5));
		f1 = new Font("Monospaced", Font.BOLD, (int) (bounds.b.clone().sub(bounds.a).y / 7.4));
	...
	public void draw(Graphics g) {
		...
		g.fillRoundRect(bounds, new Vector(30f, 30f));
		g.setAA(true);
		g.setColour(new Color(0x000000));
		g.g.setStroke(new BasicStroke(4));
		g.drawRoundRect(bounds, new Vector(30f, 30f));
		g.setFont(f0);
		g.drawString(" " + r.name, p.partitions[7].a.add(bounds.a).add(new Vector(0, f0.getSize() - f0.getSize() / 5)));
		g.setFont(f1);
		// g.drawString("Price:", p.partitions[21].a.add(bounds.a).add(new
		// Vector(0, 12f)));
		g.drawString("Price:" + Research.research.get(r.ID).cost, p.partitions[31].a.add(bounds.a));
		...
		g.fillRoundRect(p.partitions[6].a.add(bounds.a), p.partitions[21].translate(bounds.a).b, new Vector(15, 15));
		g.drawImage(b, p.partitions[6].a.add(bounds.a), p.partitions[21].b.sub(p.partitions[6].a));
		g.setColour(new Color(0x000000));
		g.drawRoundRect(p.partitions[6].a.add(bounds.a), p.partitions[21].translate(bounds.a).b, new Vector(15, 15));

		g.g.setStroke(s);
		// for (Square ss : p.partitions) {
		// g.drawRect(ss.a.add(bounds.a), ss.b.add(bounds.a));
		// }
