...
// new HugeInteger((short))
	...
	basicTower(0, 1, new HugeInteger((short) 50), new HugeInteger((short) 45), new HugeInteger((short) 10), 0, 0, "basic"),
	...
	private Purchases(int type, int strenght, HugeInteger weight, HugeInteger cost, HugeInteger health, int researchID, int id, String path) {
		...
		switch (type) {
			case 0:
				tower = new Tower(strenght, weight, cost, health, researchID, id, path);
				block = null;
				building = null;
				research = null;
				this.type = type;
